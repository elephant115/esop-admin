...
export default app => {
    ...
    // app.config.globalProperties.$uploaUrl = 'https://api-test.wukongsop.cloud/stock/common/upload'
    app.config.globalProperties.$uploaUrl = 'http://8.217.189.134:9328/stock/common/upload'
